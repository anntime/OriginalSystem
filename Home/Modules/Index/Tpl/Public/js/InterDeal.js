		...
		var option = {
			...
			tooltip : {
				...
				formatter: function (params) {
					var res;
					var url="../InterDeal/getInfoById/id/"+params[2];
					var data={id:params[2]};
					returns=yysAjaxRequest("GET",data,url);
					console.log(returns);
					res="地址："+returns[0].province+returns[0].city+"<br/>"+"IP:"+returns[0].ip+"<br/>"+""; 
					return res;
				}
			},
			series: [
...
/*
	...
	*/
	function initRequest(){
		var jsonData;
		//通过Ajax获取图表数据
		jsonData=yysAjaxRequest("GET",{},"../InterDeal/InitSimulate");
		return jsonData;
	}
	/*
	*更新CityGeoCoord（没用到）
	...
	*/
	function clickAjax(name,id,authority,series,myChart){
		...
		var jsonobj;
		jsonobj=yysAjaxRequest("GET",{id:id,request:authority},"../InterDeal/DealRequest"); 
	...
	*/
	function ajaxTimeLine(series,id,myChart,time){
		var arr=id.split(":");
		var userId=arr[1];
		var url="../InterDeal/getStartTimeline";

...
<body>
    ...
    <div id="main-content">
        ...
        <div id="main" class="main">
            ...
            <form action="<?php echo U('/Admin/UserManage/douserAdd','','');?>" method="post" class="form-horizontal">
                <div class="form-item">
                    <label class="item-label">
                        用户名
                        <span class="check-tips">（用户名会作为默认的昵称）</span>
                    </label>
                    <div class="controls">
                ...
                <div class="form-item">
                    <label class="item-label">
                        密码
                        <span class="check-tips">（用户密码不能少于6位）</span>
                    </label>
                    <div class="controls">
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="province" value=""></div>
                </div>
                <div class="form-item">
                    <label class="item-label">
                        城市
                        <span class="check-tips">（区或者市）</span>
                    </label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="city" value=""></div>
                </div>
                <div class="form-item">
                    <label class="item-label">
                        经度
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="longitude" value=""></div>
                </div>
                <div class="form-item">
                    <label class="item-label">
                        纬度
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="latitude" value=""></div>
                </div>
                <div class="form-item">
                    <label class="item-label">
                        IP地址
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="ip" value=""></div>
                </div>
                <div class="form-item">
